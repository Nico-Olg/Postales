...
const Navbar = () => {
  ...
  const navLinks = [
    ...
    { label: t('nav.inversion'), href: '#inversion' },
...
const WhatsAppButton = () => {
  ...
  return (
    <a
      href={`https://wa.me/5493434283783?text=${t('whatsapp.prefilled')}`}
...
const Gallery = () => {
  ...
  const images = [
    { title: t('gallery.img1'), placeholder: "vineyard-sunset" },
    { title: t('gallery.img2'), placeholder: "winery" },
    { title: t('gallery.img3'), placeholder: "cabin" },
    { title: t('gallery.img4'), placeholder: "glamping" }
  ];
...
const Investment = () => {
  ...
  const features = [
    ...
    t('investment.feature4'),
    t('investment.feature5'),
  ];
      ...
      <div className="container">
        ...
        >
          <div className="investment-header">
            <div>
              <span className="investment-label">{t('investment.label')}</span>
              <h3 className="investment-price">{t('investment.price')}</h3>
              <span className="investment-sublabel">{t('investment.sublabel')}</span>
            </div>
          </div>
          ...
          <div className="investment-options">
            <div className="payment-option">
              <strong>{t('investment.option1_title')}</strong>
              <span>{t('investment.option1_desc')}</span>
            </div>
            <div className="payment-option">
              <strong>{t('investment.option2_title')}</strong>
              <span>{t('investment.option2_desc')}</span>
            </div>
            <div className="payment-option">
              <strong>{t('investment.option3_title')}</strong>
              <span>{t('investment.option3_desc')}</span>
            </div>
          </div>
        ...
        >
          <div className="scarcity-content">
            <div className="scarcity-badge">
              ...
              <span>{t('scarcity.badge')}</span>
            </div>
            <h3 className="scarcity-title">
              {t('scarcity.title_pre')}<Counter end={15} />{t('scarcity.title_post')}
            </h3>
            <p className="scarcity-subtitle">
              <Counter end={5} />{t('scarcity.subtitle_post')}
            </p>
          </div>
        </motion.div>
        ...
        >
          <div className="testimonial-card">
            ...
            <p className="testimonial-text">
              {t('scarcity.testimonial1_text')}
            </p>
            <div className="testimonial-author">
              <strong>{t('scarcity.testimonial1_author')}</strong>
              <span>{t('scarcity.testimonial1_role')}</span>
            </div>
          </div>
          ...
          <div className="testimonial-card">
            <div className="testimonial-stars">★★★★★</div>
            <p className="testimonial-text">
              {t('scarcity.testimonial2_text')}
            </p>
            <div className="testimonial-author">
              <strong>{t('scarcity.testimonial2_author')}</strong>
              <span>{t('scarcity.testimonial2_role')}</span>
            </div>
          </div>
        </motion.div>
      </div>
...
const Amenities = () => {
  ...
  const amenities = [
    { icon: "🏡", title: t('amenities.item1_title'), desc: t('amenities.item1_desc') },
    { icon: "⛺", title: t('amenities.item2_title'), desc: t('amenities.item2_desc') },
    { icon: "🍷", title: t('amenities.item3_title'), desc: t('amenities.item3_desc') },
    { icon: "🌳", title: t('amenities.item4_title'), desc: t('amenities.item4_desc') },
    { icon: "☀️", title: t('amenities.item5_title'), desc: t('amenities.item5_desc') },
    { icon: "♻️", title: t('amenities.item6_title'), desc: t('amenities.item6_desc') }
  ];
    ...
    <section id="amenities" className="amenities-section">
      <div className="container">
        ...
        >
          ...
          <h2 className="section-title">{t('amenities.title_line1')}<br />{t('amenities.title_line2')}</h2>
        </motion.div>
...
const Timeline = () => {
  ...
  const phases = [
    { quarter: "2025", title: t('timeline.phase1_title'), desc: t('timeline.phase1_desc'), done: true },
    { quarter: "2026 Q1", title: t('timeline.phase2_title'), desc: t('timeline.phase2_desc') },
    { quarter: "2026 Q3", title: t('timeline.phase3_title'), desc: t('timeline.phase3_desc') },
    { quarter: "2027 Q1", title: t('timeline.phase4_title'), desc: t('timeline.phase4_desc') },
    { quarter: "2028", title: t('timeline.phase5_title'), desc: t('timeline.phase5_desc') }
  ];
            ...
            >
              ...
              <div className="timeline-content">
                <span className="timeline-quarter">
                  {phase.quarter}
                  {phase.done && <span className="timeline-done-badge">{t('timeline.done_badge')}</span>}
                </span>
...
const Contact = () => {
  ...
  try {
    ...
    const GOOGLE_SCRIPT_URL = 'https://script.google.com/macros/s/AKfycbwhcUbdP0J_HVku10sWjwmrOVthe8JMEcP1_uxMEZhNUhrNQdtyppSyyL_or1KY9SyT4g/exec';
      ...
      <div className="container">
        <div className="footer-content">
          ...
          <div className="footer-contact">
            ...
            <a href="mailto:cabanasdelvinedo@gmail.com" className="footer-link">
              cabanasdelvinedo@gmail.com
            </a>
            <a href="https://wa.me/5493434283783" className="footer-link">
              +54 9 343 44283783
            </a>
            <a href="https://wa.me/5493434283783" className="footer-link" target="_blank" rel="noopener noreferrer">
              WhatsApp
            </a>
          </div>
          ...
          <div className="footer-social">
            ...
            <div className="social-links">
              <a href="https://www.instagram.com/cabanasdelvinedo/" className="social-link" aria-label={t('footer.instagram_aria')}>
              ...
              <a href="https://www.facebook.com/cabanasdelvinedo" className="social-link" aria-label={t('footer.facebook_aria')}>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
